...
namespace ResiApp.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public ReservasController(ResiAppDBContext db)
        {
            _db = db;
        }
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            Reserva reserva = await _db.Reservas
                .Include(r => r.Usuario)
        ...
        {
            return View(new Reserva()); // ← CAMBIO APLICADO
        }
        ...
        public async Task<ActionResult> ExportarEventosPDF()
        {
            ...
            var reservasPorMes = reservas
                .GroupBy(e => new { e.FechaReserva.Year, e.FechaReserva.Month })
